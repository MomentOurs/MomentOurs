...
class MomentServiceImplTest {
    ...
    private RequestMomentDTO requestMomentDTO;
    ...
    void setUp() {
        ...
        // Mock 데이터 설정
        requestMomentDTO = new RequestMomentDTO(
                "테스트 추억",
                "맛집",
                "아 너무 맛있다.",
                true,
        ...
        mockMoment = new Moment(
                10L,
                requestMomentDTO.getMomentTitle(),
                requestMomentDTO.getMomentCategory(),
                requestMomentDTO.getMomentContent(),
                requestMomentDTO.isMomentDisclosure(),
                requestMomentDTO.isMomentCommentStatus(),
                0,
                0,
                true,
                LocalDateTime.now(),
    ...
    void createMomentTest() {
        ...
        when(momentConverter.fromDTOToEntity(any(RequestMomentDTO.class), anyLong(), anyLong()))
        ...
        // When
        ResponseMomentDTO result = momentService.createMoment(requestMomentDTO, memberId);
        ...
        verify(momentConverter, times(1))
                .fromDTOToEntity(any(RequestMomentDTO.class), anyLong(), anyLong());
